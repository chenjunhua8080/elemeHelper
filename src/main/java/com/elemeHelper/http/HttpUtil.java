...
public class HttpUtil {
    ...
    public static String wjx() throws Exception {
        String[] names = {"赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦", "尤",
            "许", "何", "吕", "施", "张", "孔", "曹", "严", "华", "金", "魏", "陶", "姜", "戚"};
        ...
        map.put("submitdata", "1$" + name + "}2$2}3$1}4$" + phone
            + "}5$1}6$}7$3}8$}9$2}10$}11$3}12$}13$1}14$}15$2}16$}17$4}18$}19$3}20$}21$4}22$}23$2}24$}25$1|11|14|17}26$}27$2|4|5|9}28$}29$1}30$}31$3}32$无}33$}34$"
            + text);
...
//        String url="https://www.wjx.cn/joinnew/processjq.ashx?curid=42677459&starttime="+URLEncoder.encode(format,"utf-8")+"&source=directphone&submittype=1&ktimes=300&hlv=1&rn="+Math.random()*999999+"&rname="+URLEncoder.encode(name,"utf-8")+"&t="+now+"&jqnonce="+ UUID.randomUUID()+"&jqsign=9383203e%2C6gc8%2C5462%2C%608%602%2C4ded9b0651%605";
        ...
        if (resp.contains("JoinID")) {
            ...
            url =
                "https://www.wjx.cn/joinnew/userawardactivity.ashx?starttime=2019%2F7%2F16%2014%3A00%3A32&t=1563257013593&activity=42677459&joinactivity="
                    + id + "&mob=1";
            ...
            if (resp.contains("_")) {
                ...
                result += "\n";
                result +=
                    "https://www.wjx.cn/mobile/getred.aspx?activity=42677459&joinactivity=" + id + "&awardId=" + giftId;
            } else if (gift.keySet().contains(resp)) {
                result += "*************中奖啦--" + gift.get(resp);
                result += "https://www.wjx.cn/joinnew/userjoinawardprovidemobo.ashx?t=" + now
                    + "&activity=42677459&joinactivity=" + id + "&mobile=&name=&address=";
            } else {
                result += "未中奖：" + resp;
            }
        }
...
//			.setProxy(proxy)
    ...
    public static Map<String, String> setCookieByPostRequest(String url, Map<String, String> cookies,
    ...
    public static Map<String, String> getCookieByPostRequest(String url, Map<String, String> cookies,
        Map<String, String> param) {
        Map<String, String> result = new HashMap<>();
